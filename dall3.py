...
client = OpenAI(api_key = "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")

chatgpt_headers = {
    "content-type": "application/json",
    "Authorization":"Bearer {}".format('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')}
